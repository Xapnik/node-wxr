...
module.exports = Importer = (function() {
  ...
  Importer.prototype.addAttachment = function(options) {
    var creator, date, description, contentEncoded, contentEncodedCDATA, excerptEncoded, excerptEncodedCDATA, item, parent, status, title, type, postID, commentStatus, pingStatus, postName, menuOrder, isSticky, attachedFileMeta, attachementImageAltMeta, guid;
