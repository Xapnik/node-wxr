...
module.exports = Importer = (function() {
  ...
  Importer.prototype.addPost = function(post) {
    var cat, catCDATA, category, contentEncoded, contentEncodedCDATA, creator, date, id, description, excerptEncoded, excerptEncodedCDATA, i, item, len, name, parent, ref, ref1, results, status, title, type, guid, commentStatus, pingStatus, postName, menuOrder, postPassword, isSticky, postMeta;
